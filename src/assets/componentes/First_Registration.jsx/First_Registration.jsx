...
function First_Registration() {
    ...
    // Se inicializan rol y estado con valores por defecto
    ...
    const handleSubmit = async (e) => {
        ...
        const userData = {
            ...
            last_name: formDataRegister.apellido,
        ...
        try {
            const response = await fetch('https://colmenaresdeleje.onrender.com/users/sign_up/', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (!response.ok) {
                if (data.error) {
                    if (data.error.includes('El usuario ya está registrado')) {
                    ...
                    <div className="col-lg-6 col-md-12 mb-3">
                        <FormContainer>
                            ...
                            <Form onSubmit={handleSubmit} ref={formRef}>
                                ...
                                <Label htmlFor="nombreApicultor">Nombre</Label>
                                <Input
                                    type='text'
                                    id="nombre"
                                    name='nombre'
                                ...
                                <Label htmlFor="apellidoApicultor">Apellido</Label>
                                <Input
                                    type='text'
                                    id="apellido"
                                    name='apellido'
                                    placeholder='Ingrese el apellido del apicultor'
                                    value={formDataRegister.apellido}
                                    onChange={handleChange}
                                    required
                                />
...
export default First_Registration;